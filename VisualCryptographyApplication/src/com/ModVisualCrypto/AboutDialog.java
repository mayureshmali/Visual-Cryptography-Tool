...
public class AboutDialog extends JDialog {
	...
	private JLabel lblCreator = new JLabel("<html>By &copy; MAYUSH </html>");
	private JLabel lblSource = new JLabel("<html>Based on the classic encryption technique proposed by Naor and Shamir in 1994 at EuroCrypt(Modified Version) .</html>");
	...
	public AboutDialog(JFrame parent) {
		...
		this.add(Box.createVerticalStrut(10));
		this.setIconImage(new ImageIcon(getClass().getResource("crypto.png")).getImage());
